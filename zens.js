...
const nyoutube = ('®  hendra')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                zens.sendMessage(m.chat, { image: { url: 'https://youtube.com/channel/UC7flTES4TqWBLOPxk25_tsAfile/0b31865ef182a7681f9c3.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://chat.whatsapp.com/Fj5z7EXvGLVARaZ0cJF8rd\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n chat nomor berikut : wa.me/6281227607864\n\n_Terima kasih_` }, { quoted: m })
            }
            break 
            case 'chat': {
